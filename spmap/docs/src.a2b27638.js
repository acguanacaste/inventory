...
module.exports = Object.freeze({
  LAYER_PREFIX: "toggle-",
  // the layer name prefix used to determine top-level filter layers
  LAYERS_ACTIVE: true,
  // are the layers all active or disabled by default?
  ANIMATION_DURATION: 2000,
  // duration in ms for fly/pan animation
...
exports.getFilteredLayers = exports.getVisibleLayers = exports.filteringLayersList = void 0;
...
var PREFIX_LENGTH = _config.LAYER_PREFIX.length; //toggle- prefix on the layers name
...
var filteringLayersList = filteringLayers.map(function (_ref5) {
  var name = _ref5.name;
  return name;
});
exports.filteringLayersList = filteringLayersList;
...
var getVisibleLayers = function getVisibleLayers(layerList) {
...
var getFilteredLayers = function getFilteredLayers(layerList) {
...
exports.getHideAllHandler = exports.getShowAllHandler = exports.getFilterToggleHandler = exports.getFilterLayerToggleHandler = exports.getLayerToggleHandler = exports.toggleLegend = void 0;
...
var getLayerToggleHandler = function getLayerToggleHandler(map) {
  return function (layerId) {
    // toggle class
    var legendItem = document.getElementById(layerId);
    legendItem.classList.toggle("active"); // toggle state
...
exports.getLayerToggleHandler = getLayerToggleHandler;

var getFilterLayerToggleHandler = function getFilterLayerToggleHandler(map) {
  return function (layerId) {
    var legendItem = document.getElementById(layerId);
    legendItem.classList.toggle("active");
    var legendItemEls = document.querySelectorAll("#".concat(layerId, " .legend-item"));
    var currentLayerState = map.visibleLayers[layerId]; // if any items were active, they are now all inactive
    ...
    var visibility = isToggledOn ? "visible" : "none"; // update map.visibleLayers state
    ...
    isToggledOn && map.setFilter(layerId, null); // Toggle Layer visibility
...
exports.getFilterLayerToggleHandler = getFilterLayerToggleHandler;

var getFilterToggleHandler = function getFilterToggleHandler(map) {
  return function (layerId, value) {
    // Toggle Active Class
    var legendItem = document.getElementById("".concat(layerId, "-").concat(value));
    legendItem.classList.toggle("active");

    if (layerId) {
      var layerConfig = _config.LAYERS[layerId];
      var layerData = map.visibleLayers[layerId];
      map.visibleLayers[layerId][value] = !layerData[value]; // If this filter is active, it's parent should be active too
      ...
      if (activeFilterLayers.length > 0) {
        map.setLayoutProperty(layerId, "visibility", "visible"); // build the filter query, using filterOn for the field to filter on,
...
exports.getFilterToggleHandler = getFilterToggleHandler;

var toggleLayersAndCombinedLayers = function toggleLayersAndCombinedLayers(map) {
  var newState = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "visible";
  map.filteredLayers.map(function (layer) {
    map.setLayoutProperty(layer.name, "visibility", newState);

    if (_config.LAYERS[layer.name] && _config.LAYERS[layer.name].combineWithLayers) {
      _config.LAYERS[layer.name].combineWithLayers.forEach(function (additionalLayer) {
...
var toggleFilterItems = function toggleFilterItems(query) {
  var verb = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "add";
  var newClass = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "active";
  var legendItemEls = document.querySelectorAll(query);
  [].forEach.call(legendItemEls, function (item) {
...
var getShowAllHandler = function getShowAllHandler(map) {
  return function () {
    // toggle layers that start with toggle-
    toggleLayersAndCombinedLayers(map, "visible"); // set filters
    ...
    map.visibleLayers = (0, _utils.getVisibleLayers)(map.layerList, true); // Toggle active class
...
exports.getShowAllHandler = getShowAllHandler;

var getHideAllHandler = function getHideAllHandler(map) {
  return function () {
    toggleLayersAndCombinedLayers(map, "none");
    map.visibleLayers = (0, _utils.getVisibleLayers)(map.layerList); // Toggle active class
...
exports.getHideAllHandler = getHideAllHandler;
...
var _default = function _default(allLayers) {
  return (0, _nanohtml.default)(_templateObject(), _handlers.toggleLegend, _config.TEXT.LEGEND_TITLE, allLayers.map(function (layer) {
    if (layer.hasFilters) {
...
var legendItem = function legendItem(_ref) {
  var name = _ref.name,
      color = _ref.color,
      label = _ref.label;
  return (0, _nanohtml.default)(_templateObject2(), _config.TEXT.LEGEND_ITEM_TOOLTIP_PREFIX, label, name, getLayerToggle(name), color, label);
};
...
var legendItemChild = function legendItemChild(_ref2) {
  var value = _ref2.value,
      ...
      color = _ref2.color,
      label = _ref2.label;
  return (0, _nanohtml.default)(_templateObject3(), _config.TEXT.LEGEND_ITEM_TOOLTIP_PREFIX, _config.LAYERS[layerId].label, value, layerId, value, getFilterItemToggle(layerId, value), color, label);
};
...
var legendItemWithFilters = function legendItemWithFilters(_ref3) {
  ...
  return (0, _nanohtml.default)(_templateObject4(), name, color, _config.TEXT.LEGEND_ITEM_TOOLTIP_PREFIX, label, getFilterLayerToggle(name), label, filters.map(legendItemChild));
};
...
var _default = function _default(feature) {
  return "<div class=\"popup-header\">\n    <h3>\n        <a\n          href=\"".concat(feature.properties.link, "\"\n          >\n          ").concat(feature.properties.Estación, "\n        </a>\n    </h3>\n    <div class=\"popup-image\">\n        <a\n          href=\"").concat(feature.properties.link, "\"\n          >\n          <img\n            src=\"").concat(feature.properties.Image, "\"\n            alt=\"").concat(_config.TEXT.POPUP_IMAGE_ALT_PREFIX, " ").concat(feature.properties.Estación, "\"\n          />\n        </a>\n\n    </div>\n  </div>\n  <div class=\"popup-content\">\n    <div class=\"popup-description\">\n      <p>").concat(feature.properties.description, "</p>\n    </div>\n    <a\n      class=\"button button-block\"\n      href=\"").concat(feature.properties.link, "\"\n      >\n      ").concat(_config.TEXT.POPUP_MORE_INFO, "\n    </a>\n  </div>\n  ");
};
...
exports.toggleLayer = exports.handleInitialLoad = void 0;
...
var handleInitialLoad = function handleInitialLoad(map) {
  ...
  map.filteredLayers = (0, _utils.getFilteredLayers)(map.layerList); // HANDLE MAP LOAD
...
var toggleLayer = function toggleLayer(map, layerId) {
...
function createCompass(map) {
  ...
  var compass = (0, _nanohtml.default)(_templateObject());
...
function getMap() {
  var map = new mapboxgl.Map( // Set defaults, allow the config to override
  Object.assign(DEFAULT_MAP, _config.MAP));
  var popup = new mapboxgl.Popup(); // Create a mapboxgl.Popup from the default popup component.

  var showPopup = function showPopup(feature) {
    popup.setLngLat(feature.geometry.coordinates).setHTML((0, _popup.default)(feature)).addTo(map);
    popup.on("close", function () {// map.flyTo({
      //   center: MAP.center,
  ...
  .filter(function (_ref) {
    ...
    map.on("click", layerId, function (e) {
      var feature = e.features[0]; // map.flyTo({
  ...
  map.addControl(new mapboxgl.FullscreenControl()); // Add zoom conntrol

  var nav = new mapboxgl.NavigationControl({
    showCompass: false
  });
  map.addControl(nav, "top-left"); // disable scrollZoom

  map.scrollZoom.disable();
  createCompass(map);
  return map;
}
},{"./components/popup":"src/components/popup.js","nanohtml":"node_modules/nanohtml/lib/browser.js","./utils":"src/utils.js","./handlers":"src/handlers.js","./config":"src/config/index.js"}],"../../../../Users/federicomatarrita/.config/yarn/global/node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
},{}],"../../../../Users/federicomatarrita/.config/yarn/global/node_modules/parcel-bundler/src/builtins/css-loader.js":[function(require,module,exports) {
...
},{"./bundle-url":"../../../../Users/federicomatarrita/.config/yarn/global/node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"assets/styles/index.scss":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"./../svg/up-arrow.svg":[["up-arrow.3f54d1be.svg","assets/svg/up-arrow.svg"],"assets/svg/up-arrow.svg"],"./../svg/down-arrow.svg":[["down-arrow.811ee7d2.svg","assets/svg/down-arrow.svg"],"assets/svg/down-arrow.svg"],"./../svg/park-11.svg":[["park-11.e36f7fa7.svg","assets/svg/park-11.svg"],"assets/svg/park-11.svg"],"_css_loader":"../../../../Users/federicomatarrita/.config/yarn/global/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/index.js":[function(require,module,exports) {
"use strict";
...
var map = (0, _map.default)();
map.initialLoaded = false;
map.visibleLayers = {};
map.layerList = []; // debugging only
// window.map = map;
...
map.on("load", function () {
  ...
  var legendInnerEl = (0, _legend.default)(_toConsumableArray(map.filteredLayers));
...
},{"./components/legend":"src/components/legend.js","./map":"src/map.js","../assets/styles/index.scss":"assets/styles/index.scss"}],"../../../../Users/federicomatarrita/.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../../Users/federicomatarrita/.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/index.js"], null)
